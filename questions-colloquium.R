# Comparing Sibling mean vs. sibling-only PGS to predict sibling interaction
...
gnome_mx_sibonly <- function(
  ...
  for (ngp_i in seq_along(npgsloci)) {
    ...
    for (i in 1:n_set) {
      ...
      phdatdzL_e[,8]=c(phdatdz_e$pgst2,phdatdz_e$pgst1) # CHANGED to other twins PGS
      #
...
# Assortative Mating - Dirk's Question
