...
#
nmz=1999  # sample size MZ pairs
ndz=2001  # sample size DZ pairs
#
...
par_gs=p_gs=sqrt(c(0.07)) # ,.01,.025))   # parent genotype to twins phenotype
par_bs=p_bs=sqrt(c(0.0)) #,.01,.025))   # twin 1 (2) genotype to twin 2 (1) phenotype ................ source of misfit 
