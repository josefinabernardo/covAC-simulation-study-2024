...
#
stzPRS=TRUE # standardize the prs
#
...
par_gs=p_gs=sqrt(c(0,.01,.025))   # parent genotype to twins phenotype
par_bs=p_bs=sqrt(c(0,.01,.025))   # twin 1 (2) genotype to twin 2 (1) phenotype
...
SLmz[5,7]=SLmz[7,5]=VA1/2   # MZ
SLmz[6,8]=SLmz[8,6]=VP/2    # MZ
#
...
#  FD'G'       |  DGD'
#
# DFD' is the covariance matrix 6x6 of the prs
# D 6x6 diagonal contains the stds of the PRS (all 1 probably)
# F is the 6x6 correlation matrix of the PRS. all fixed to theoretical values
#
...
#
# fit the model
Model_1out <- mxRun(Model_1, intervals=T)
#
summary(Model_1out)
#
